		...
		<div className={ classnames( 'be-support-content-block-icon', { 'is-margin-right': props.marginRight } ) }>
			<SVG width="18" height="18" viewBox="0 0 18 18" xmlns="http://www.w3.org/2000/svg">
				<Path
					...
					strokeWidth="1.5"
				/>
				<Path d="M6 1L2 5.5L2 1L6 1Z" fill="currentColor" stroke="currentColor" />
				<Path d="M11 12.2857L14 9L11 6" stroke="currentColor" strokeWidth="1.5" />
				<Path d="M7 12.2857L4 9L7 6" stroke="currentColor" strokeWidth="1.5" />
			</SVG>
		</div>
	);
};
